  ...
  return (
    <div className='text-white flex flex-col items-center justify-center'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
            <div className='flex flex-col items-center justify-center w-[270px] bg-black space-y-2 border p-4 overflow-hidden rounded-lg hover:shadow-[0_0_25px_5px_rgba(0,255,0,0.5)] hover:scale-[1.1] transition-transform'>
